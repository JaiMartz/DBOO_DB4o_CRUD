    ...
    public static void main(String[] args) {
        ...
        if(consulta.size() == 0){
            ...
            while(consulta.hasNext()){
                ...
                System.out.println("\nCódigo Empleado: "+emp_actual.getCodEmpleado()+"\t\tNombre: "+emp_actual.getNombre()+"\t\tApellido: "+emp_actual.getApellido()
                +"\t\tPuesto: "+emp_actual.getPuesto()+"\t\tSalario: "+emp_actual.getSalario());
            }
        }
